...
## Cross-Episode Resources & Templates

- Starter repo scaffold (see `agentic-ai/starter/` — suggested): virtualenv, Dockerfile, basic test harness
- Templates: architecture diagram, capability-matrix, evaluation harness, HIL flow template
- Recommended libraries & tools: OpenAI or compatible LLM client, LangChain (patterns only), FAISS, Milvus/Pinecone/Weaviate, Playwright, Prometheus/Jaeger for observability
- Suggested reading: research papers on ReAct, chain-of-thought, RAG; docs for vector DBs; SRE reliability patterns

---

## Suggested Episode Durations & Formats

- Format: 12–18 minute episode + companion notebook/repo for hands-on
- Each episode: short lecture (6–10m), live coding/demo (4–8m), and 1–2 exercises
- Assessment: small artifact per episode (notebook, mini-service, or doc)

---

## How to use this roadmap

- Follow episodes sequentially or pick tracks (Foundations → Tooling → Orchestration → Enterprise → Capstone)
- Clone `agentic-ai` folder and add episode folders as you build demos
- Submit PRs with artifacts and add your own resources to expand the syllabus

---

_Maintainer: Add links to episode folders, notebooks, and CI instructions as they are created._
